...
REQUIRED_PHASE7_SYMBOLS = [
    ...
    "SdkUsageRollupViewInput",
    "SdkUsageRollupView",
    "decode_usage_rollup_view",
    "SdkSealLedgerReferenceViewInput",
    "SdkSealLedgerReferenceView",
    "decode_seal_ledger_reference_view",
    "SdkReceiptReferenceViewInput",
    "SdkReceiptReferenceView",
    "decode_receipt_reference_view",
...
REQUIRED_PHASE7_TESTS = [
    ...
    "phase7_usage_rollup_reader_preserves_service_refs",
    "phase7_seal_ledger_and_receipt_ref_readers_require_service_evidence",
